...
CREATE TABLE NEW_ORDER (
  ...
  CONSTRAINT NO_FKEY_O FOREIGN KEY (NO_W_ID, NO_D_ID, NO_O_ID) REFERENCES "order" (O_W_ID, O_D_ID, O_ID)
);
...
(
  ...
  CONSTRAINT OL_FKEY_O FOREIGN KEY (OL_W_ID, OL_D_ID, OL_O_ID) REFERENCES "order" (O_W_ID, O_D_ID, O_ID),
